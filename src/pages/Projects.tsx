  ...
  const projects: Project[] = [
    {
      ...
      description: 'A full-stack web application allowing users to upload medical report PDFs and interact with the content',
      points: [
      ...
      technologies: ['React', 'TypeScript', 'Node.js', 'Pinecone DB', 'AWS S3', 'Clerk', 'Stripe', 'OpenAI'],
      github: '#'
    },
    {
      title: 'Stockii',
      period: 'Jan 2025 - uOttaHacks',
      description: 'A stock tracking application built with TypeScript, React, and RESTful API',
      points: [
      ...
      technologies: ['TypeScript', 'React', 'RESTful API', 'Tailwind CSS', 'OAuth', 'Google API'],
      github: '#'
    },
    {
      title: 'BetterReads',
      period: 'May 2024 - Jun 2024',
      description: 'A Java application for the Memorial High School library that allows users to scan books',
      points: [
      ...
      <div className="animate-fade-in">
        ...
        <div className="space-y-16">
          {projects.map((project, index) => (
            <div key={index} className="border-l-2 border-gray-800 pl-6 py-2 hover:border-portfolio-accent transition-colors project-item">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                <h2 className="text-2xl font-semibold">{project.title}</h2>
                <div className="text-portfolio-muted text-sm">{project.period}</div>
              </div>
